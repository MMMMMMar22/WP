...
import initVirtualReality from "./../components/initVirtualReality.js";
import initCallToAction from "./../components/initCallToAction.js";
...
const homePage = () => {
  ...
  const vrNode = rootNode.querySelector(".virtual_reality");
  initVirtualReality(vrNode);

  // call to action
  const ctaNode = rootNode.querySelector(".call_to_action");
  initCallToAction(ctaNode);
